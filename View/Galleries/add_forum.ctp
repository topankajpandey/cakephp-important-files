            ...
            <div class="row">
                ...
                <div class="col-xs-12 form-group">
                    ...
                    echo $this->form->input('Forum.Subject', array(
                        'class' => 'form-control',
                        'required' => false,
                        'value' => $get_galleries['Gallery']['Name'] . ' Forum Conversation',
                ...
                <div class="edit-action checkbox-btn possition-input"><hr> 
                    <?php echo $this->Form->input('Forum.GalleryID', array('type' => 'hidden', 'value' => $get_galleries['Gallery']['GalleryID'])); ?>
                    <?php echo $this->Form->input('Forum.ProjectID', array('type' => 'hidden', 'value' => $get_galleries['Gallery']['GalleryID'])); ?>
