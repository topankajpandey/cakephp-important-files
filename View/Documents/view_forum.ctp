        ...
        <div id="tabs" class="ui-tabs">
            <div id="tabs-2" class="forum-table">
                <h1 class="p-l-0 contract-forum-view-button">Showing the thread list
                    <?php echo $this->Html->link($this->Html->tag('span', '', array('class' => 'fa fa-arrow-left')), '/documents', array('title' => 'Back to Documents', 'escape' => false)); ?>
                </h1>
            </div>
        </div>
                ...
                foreach ($forumData as $thread) {
                    ...
                    ?><div class="forum-thread" id="thread_<?php echo $thread['Forum']['ForumPostID']; ?>" style="margin-left:<?php echo $margin_value; ?>px">
                        ...
                        <div class="forum_action_buttons">
                            <?php echo $this->Html->link('Reply', array('controller' => 'documents', 'action' => 'reply_forum', $thread['Forum']['ForumPostID'], $forum_thread), array('title' => 'Reply', 'escape' => false)); ?>
                        </div>
